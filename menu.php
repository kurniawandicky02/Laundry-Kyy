...
<!-- ini navbar Bosq-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container-fluid">
       <a class="navbar-brand" style="font-size: 15px; color: aqua;" href="index.php">Home<i class="fa-solid fa-house" style="color: blue;  margin-left: 3px;"></i></a>
...
<h6 class="m-0 font-weight-bold text-primary">Tambah Costumer:</h6>
  ...
  <div class="card-body">
  <?php
      echo "<font class='tanggal' color='white' size='4px'>".date('l, d-m-y ');
      echo "</font>";
       ?>
